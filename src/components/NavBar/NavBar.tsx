...
<span className="self-center text-xl font-semibold whitespace-nowrap text-redPizza">Pzza</span>
</a>
...
<li>
<Link to="/" className="block py-2 pr-4 pl-3 text-white bg-redHover rounded md:bg-transparent md:text-redHover md:p-0 dark:text-white" aria-current="page">Home</Link>
</li>
<li>
